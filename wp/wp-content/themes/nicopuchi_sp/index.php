            ...
            <ul id="puchinew10" class="index-list-type02">
                <li>
                    <a href="" class="new">
                        <dl>
                            <dt>
                                <img class="full" src="/common/img/pc/index/img_sample06a.png" alt="">
                ...
                <li>
                    <a href="" class="new">
                        <dl>
                            <dt>
                                <img class="full" src="/common/img/pc/index/img_sample06b.png" alt="">
                                <span class="date">2015.00.00</span>
                            </dt>
                            <dd>
                                <p class="desc">
                ...
                <li>
                    <a href="">
                        <dl>
                            <dt>
                                <img class="full" src="/common/img/pc/index/img_sample06c.png" alt="">
                                <span class="date">2015.00.00</span>
                            </dt>
                            <dd>
                                <p class="desc">
