    ...
    <div class="module-type01">
        <div class="module-body bg-type03 inner10">
            <div class="module-head">
                <h2 class="module-head-ttl mb10"><img class="full" src="/common/img/sp/04/ttl01.png" alt="プチモ☆ブログ"></h2>
            </div>
            <div class="blogname cFix">
                <table>
                    <tr>
                        <th scope="row" class="blog_ph"><img src="<?php home(); ?>/common/img/sp/04/blog_ttl_ph.png"></th>
                        <td><div class="arrow_box"> <span class="name">ゆうⓒ</span>の<span class="pink">ブログ</span> </div></td>
                    </tr>
                </table>
                <div>
                </div>
                ...
                <?php if (have_posts()) : the_post(); ?>
                    <div class="entry cFix">
                        ...
                        <ul class="pageNav01">
                            ...
                            <li><a href="#">ゆう©の記事一覧</a></li>
                            <li class="fl_r"><a href="#"><img src="/common/img/sp/arrow_R.jpg" width="12" height="12"></a></li>
                        </ul>
                        <a href="" class="btn type02 tx_c mt10 mb20"><span class="tx12"><img src="../common/img/sp/04/icn_arrow.jpg" width="32" height="22">プチモブログ一覧</span></a>
